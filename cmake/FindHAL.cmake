...
foreach(COMP ${HAL_REQUESTED_FAMILIES})
    ...
    if(HAL_${FAMILY}_PATH_NOT_FOUND)
...
message("P2H requested families before cleanup : ${HAL_REQUESTED_FAMILIES}")
if(STM32H7 IN_LIST HAL_REQUESTED_FAMILIES)
    list(REMOVE_ITEM HAL_REQUESTED_FAMILIES STM32H7)
    list(APPEND HAL_REQUESTED_FAMILIES STM32H7_M7 STM32H7_M4)
endif()

if(STM32WB IN_LIST HAL_REQUESTED_FAMILIES)
    list(REMOVE_ITEM HAL_REQUESTED_FAMILIES STM32WB)
    list(APPEND HAL_REQUESTED_FAMILIES STM32WB_M4)
endif()

if(STM32WL IN_LIST HAL_REQUESTED_FAMILIES)
    list(REMOVE_ITEM HAL_REQUESTED_FAMILIES STM32WL)
    list(APPEND HAL_REQUESTED_FAMILIES STM32WL_M4 STM32WL_M0PLUS)
endif()

if(STM32MP1 IN_LIST HAL_REQUESTED_FAMILIES)
    list(REMOVE_ITEM HAL_REQUESTED_FAMILIES STM32MP1)
    list(APPEND HAL_REQUESTED_FAMILIES STM32MP1_M4)
endif()

message("P2H requested families after cleanup : ${HAL_REQUESTED_FAMILIES}")
...
foreach(COMP ${HAL_REQUESTED_FAMILIES})
    ...
    foreach(DRV_COMP ${HAL_FIND_COMPONENTS_DRIVERS_LL})
        ...
        list(APPEND HAL_${FAMILY}${CORE_U}_SOURCES "${HAL_${FAMILY}${CORE_U}_${DRV}_LL_SOURCE}")
